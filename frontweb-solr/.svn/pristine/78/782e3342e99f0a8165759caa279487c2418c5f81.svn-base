...
<div id="shortcut-2013">
	<div class="w">
		...
		<ul class="fr lh">
			<li class="fore1" id="loginbar">您好，欢迎来到京东！<span><a href="http://www.atguigu.com/user/login.html">[登录]</a> <a href="http://www.atguigu.com/user/reg.html" class="link-regist">[免费注册]</a></span></li>
			<li class="fore2 ld">
				<s></s>
...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.jd.com/" hidefocus="true"><b></b><img src="<c:url value='/resource'/>/reglogo.png" width="238" height="67" alt="京东"></a></div>
		<!--logo end-->
		<div id="search-2013">
			<div class="i-search ld">
				...
				<input type="hidden" name="cid" id="catalog_name" value="${cid }"/> 
			...
			<div class="attr">
				...
				<div class="a-values">
					<div class="v-tabs">
						<div class="tabcon">
							<div>
								<a href="javascript:filter('cid', '560')" >幽默杂货</a>
							</div>
							<div>
...
<div id="plist" class="m plist-n7 plist-n8 prebuy">
	<ul class="list-h">
		...
		<li pid="${product.id }">
			<div class="lh-wrap">
				<div class="p-img">
					<a target="_blank" href="http://product.atguigu.com/product/${product.id }.html">
						<img width="220" height="282" class="err-product" src="${product.image}">
					</a>
				</div>
				<div class="p-name">
				...
				<div class="p-price">
					<strong>￥<fmt:formatNumber value="${product.price}" maxFractionDigits="2"/></strong><span id="p1269191543"></span>
				</div>
			</div>
		</li>
		</c:forEach>

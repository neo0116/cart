 ...
 */
function login() {
    return location.href = "http://www.atguigu.com/page/login.html";
}
function regist() {
    return location.href = "http://www.atguigu.com/page/register.html";
}
...
function search(a) {
    var b = "http://search.atguigu.com/search.html?queryString=" + encodeURIComponent(document.getElementById(a).value);

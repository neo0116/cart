...
<div id="shortcut-2013">
	<div class="w">
		...
		<ul class="fr lh">
			<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">您好！欢迎来到尚商！<a href="javascript:login()">[登录]</a>&nbsp;<a href="http://www.atguigu.com/user/reg.html">[免费注册]</a></li>

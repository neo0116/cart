...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.atguigu.com/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="/images/reglogo.png" width="238" height="67" alt="尚商"></a></div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
			<dl>
				<dt class="ld"><s></s><span class="shopping"><span id="shopping-amount"></span></span><a href="http://www.atguigu.com/cart/show.html" id="settleup-url">去购物车结算</a> <b></b> </dt>
<!-- 				<dd>
					<div class="prompt">
						<div class="loading-style1"><b></b>加载中，请稍候...</div>
					</div>
